...
public class MainframeController {
  ...
  public void onDataRecords(ActionEvent event) throws IOException {
    ...
    controller.getTblvDatarecords().getItems().addAll(service.getTrackings());
  ...
  private void setEvaluation() throws IOException {
    ...
    controller.getLblBreaksM().setText(format.format(month.getBreaks()));
    controller.getLblBreaksY().setText(format.format(year.getBreaks()));
    controller.getLblBalanceM().setText(format.format(month.getBalance()));
    controller.getLblBalanceY().setText(format.format(year.getBalance()));
    controller.getLblOwnM().setText(format.format(month.getOwn()));
    controller.getLblOwnY().setText(format.format(year.getOwn()));
    controller.getLblOvertimeM().setText(format.format(month.getOvertime()));
    controller.getLblOvertimeY().setText(format.format(year.getOvertime()));
    controller.getLblQuotaM().setText(format.format(month.getQuota()));
    controller.getLblQuotaY().setText(format.format(year.getQuota()));
    spView.setContent(root);
  ...
  private void setStandardWeek() throws IOException {
    ...
    DecimalFormat format = new DecimalFormat("00.00");
    controller.getLblBreaks().setText(format.format(week.getBreaks()));
    controller.getLblBalance().setText(format.format(week.getBalance()));
    controller.getLblOwn().setText(format.format(week.getOwn()));
    controller.getLblOvertime().setText(format.format(week.getOvertime()));
    controller.getLblQuota().setText(format.format(week.getQuota()));
    spView.setContent(root);
