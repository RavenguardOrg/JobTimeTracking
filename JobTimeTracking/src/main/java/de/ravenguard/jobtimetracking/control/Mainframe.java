...
import de.ravenguard.jobtimetracking.logic.EvaluationData;
import de.ravenguard.jobtimetracking.logic.TimeTrackingService;
...
public class Mainframe {
    ...
    public void onEditProfile(ActionEvent event) throws IOException {
        ...
        // Set Values before
        de.ravenguard.jobtimetracking.model.Profile profile = service.getProfile();
    ...
    public void onBreak(ActionEvent event) throws IOException {
        ...
        String template = "/jobtimetracking/fxml/popupBreak.fxml";
     ...
     * @return
     */
    private boolean validateNewProfile(Profileediting profileController, Dialog<ButtonType> dialog) {
     ...
     * @return
     */
    private boolean validateManualTracking(Manualtimetracking manualTrackingController, Dialog<ButtonType> dialog) {
        List<String> errors = new ArrayList<>();
